...
class maze:
    ...
    def CreateMaze(self,x=1,y=1,pattern=None,loopPercent=0,saveMaze=True,savepng=True,loadMaze=None,theme:COLOR=COLOR.dark):
        '''
        ...
        if saveMaze:
            dt_string = datetime.datetime.now().strftime("%d--%H-%M")
    ...
    def _drawMaze(self,theme):
        ...
        self._win.title('Maze/Map pathing')
