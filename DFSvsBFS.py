...
class MyMaze(maze):
    def savepng(self, maze_map, fwdBFSPath, fwdDFSPath):
        dt_image = datetime.datetime.now().strftime("%d--%H-%M-%S")
        # Create an image
...
total_space4 = 0
total_space4 += sys.getsizeof(a)
total_space4 += sys.getsizeof(b)
print(f"The total space usage of the total pathings is {total_space4} bytes.")
